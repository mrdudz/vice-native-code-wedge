...
extern char load(unsigned int address);
extern void store(unsigned int address, char value);
extern void clear_jump_table(void);
extern void set_jump(unsigned int address, void* function);
